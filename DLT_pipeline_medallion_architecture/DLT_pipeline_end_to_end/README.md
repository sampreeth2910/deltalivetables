# DLT_pipeline_end_to_end

The 'DLT_pipeline_end_to_end' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/DLT_pipeline_end_to_end/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] DLT_pipeline_end_to_end_etl` to your workspace.
